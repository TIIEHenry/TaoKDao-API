...
public class TabPagerViewPager extends ViewPager {
    public static int dp2px(float dpValue) {
        return (int) (0.5f + dpValue * Resources.getSystem().getDisplayMetrics().density);
    }

    public TabPagerViewPager(@NonNull Context context) {
        super(context);
        init();
    }

    public TabPagerViewPager(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
