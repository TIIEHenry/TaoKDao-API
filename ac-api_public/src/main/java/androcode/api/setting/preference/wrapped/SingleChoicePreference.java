...
public class SingleChoicePreference implements ISingleChoicePreference {
    ...
    @MainConstructor
    public SingleChoicePreference(@NonNull SharedPreferences sharedPreferences, int defaultValue, @NonNull Properties properties, Drawable icon, Listener listener) {
    ...
    public SingleChoicePreference(@NonNull SharedPreferences sharedPreferences, int defaultValue,@NonNull Properties properties, Listener listener) {
