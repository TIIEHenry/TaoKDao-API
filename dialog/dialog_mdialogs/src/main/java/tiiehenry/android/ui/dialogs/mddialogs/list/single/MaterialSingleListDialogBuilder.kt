...
class MaterialSingleListDialogBuilder(val context: Context) :
    MaterialBaseListDialogBuilder<ISingleListDialogBuilder>, ISingleListDialogBuilder {
    ...
    override fun itemsCallbackSingleChoice(
        selectedIndex: Int,
