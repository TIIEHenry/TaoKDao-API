...
class MaterialLoadingDialogWrapper(
    builder: MDLoadingDialogBuilder,
    val layout: View,
    val loadTemp: LoadTemp
) : MaterialDialogBaseWrapper(builder.builder.applyTheme()), ILoadingDialog {
