...
class MaterialMultiListDialogBuilder(val context: Context) :
    MaterialBaseListDialogBuilder<IMultiListDialogBuilder>, IMultiListDialogBuilder {
    ...
    override fun itemsCallbackMultiChoice(
        selectedIndices: IntArray?,
        callback: ListCallbackMultiChoice
    ): IMultiListDialogBuilder {
